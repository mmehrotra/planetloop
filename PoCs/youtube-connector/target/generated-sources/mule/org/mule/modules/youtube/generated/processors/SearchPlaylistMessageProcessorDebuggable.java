...
public class SearchPlaylistMessageProcessorDebuggable
    extends SearchPlaylistMessageProcessor
    implements DebugInfoProvider
{


    public SearchPlaylistMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
