...
public class SearchNextPreviousPageMessageProcessorDebuggable
    extends SearchNextPreviousPageMessageProcessor
    implements DebugInfoProvider
{


    public SearchNextPreviousPageMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("pageToken", "Page token", (java.lang.String.class), pageToken, muleEvent));
