...
public class UploadVideoMessageProcessorDebuggable
    extends UploadVideoMessageProcessor
    implements DebugInfoProvider
{


    public UploadVideoMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("video", "Video", (java.io.File.class), video, muleEvent));
