...
public class GetVideoDetailsMessageProcessorDebuggable
    extends GetVideoDetailsMessageProcessor
    implements DebugInfoProvider
{


    public GetVideoDetailsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("ratings", "Ratings", (com.planetloop.integration.youtube.common.CommonConstants.RATINGS.class), ratings, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("videoCategoryId", "Video category id", (java.lang.String.class), videoCategoryId, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("maxResults", "Max results", (java.lang.String.class), maxResults, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("id", "Id", (java.lang.String.class), id, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("chart", "Chart", (com.planetloop.integration.youtube.common.CommonConstants.CHART.class), chart, muleEvent));
