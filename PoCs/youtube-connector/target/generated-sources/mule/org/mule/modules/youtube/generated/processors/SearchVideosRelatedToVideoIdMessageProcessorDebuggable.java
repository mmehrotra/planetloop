...
public class SearchVideosRelatedToVideoIdMessageProcessorDebuggable
    extends SearchVideosRelatedToVideoIdMessageProcessor
    implements DebugInfoProvider
{


    public SearchVideosRelatedToVideoIdMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("relatedToVideoId", "Related to video id", (java.lang.String.class), relatedToVideoId, muleEvent));
