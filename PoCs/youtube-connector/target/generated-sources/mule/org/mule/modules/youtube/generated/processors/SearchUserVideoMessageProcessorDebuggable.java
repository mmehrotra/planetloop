...
public class SearchUserVideoMessageProcessorDebuggable
    extends SearchUserVideoMessageProcessor
    implements DebugInfoProvider
{


    public SearchUserVideoMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("orderBy", "Order by", (com.planetloop.integration.youtube.common.CommonConstants.ORDER_BY.class), orderBy, muleEvent));
