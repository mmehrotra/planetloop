...
public class SearchVideosMessageProcessorDebuggable
    extends SearchVideosMessageProcessor
    implements DebugInfoProvider
{


    public SearchVideosMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("videoDuration", "Video duration", (java.lang.String.class), videoDuration, muleEvent));
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("order", "Order", (java.lang.String.class), order, muleEvent));
